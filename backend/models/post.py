...
post_model = api.model("post_model", {
    ...
    "creation_datetime": fields.DateTime(description="Post creation date/time", required=True),
    "date_last_modified": fields.DateTime(description="Post last modified date/time", required=True),
